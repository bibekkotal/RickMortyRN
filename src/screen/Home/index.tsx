...
const Home = () => {
  ...
  const { data, error, isLoading, hasNextPage, fetchNextPage, isFetchingNextPage } = useInfiniteQuery('randomCharacter', apiCharacter.fetchAllCharacter, {
    ...
    return (
      ...
      <TouchableOpacity View key={item.id} 
          ...
          style={{
            ...
            backgroundColor: isDarkMode ? LIGHT : DARK, elevation: 5
          }}>
  ...
  const _itemSeparatorComponent = () => {
    return (
      <View style={{ backgroundColor: backgroundStyle.backgroundColor, margin: 8 }} />
    )
  }
    ...
    <SafeAreaView style={backgroundStyle}>
      ...
      {isLoading ?
        ...
        <>
          ...
          >
            <View style={{ flex: 0.8, backgroundColor: !isDarkMode ? LIGHT : DARK, }}>
              <FastImage
                style={{ flex: 1 }}
                source={{
